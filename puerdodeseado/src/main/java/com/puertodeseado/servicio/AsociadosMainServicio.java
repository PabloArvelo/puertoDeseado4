    ...
    public void importarDesdeCSV(MultipartFile archivoCSV) throws Exception {
        ...
        try (Reader reader = new InputStreamReader(archivoCSV.getInputStream(), StandardCharsets.UTF_8)) {
            ...
            for (String[] registro : registros) {
                ...
                crearAsociado(apellido, nombre, departamentoLaboral, fechaNacimiento, nacionalidad, dni, cuil, estadoCivil, grupoSanguineo, telFijo, telMovil, email, calle, numero, piso, dpto, barrio, distrito, provincia, codigoPostal, null,salarioMinimo);
            }
        } catch (Exception e) {
